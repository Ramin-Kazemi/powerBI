...
# Custom header
st.markdown("""
# 🌿 Agritech Pest & Weather Analysis Dashboard

Welcome to a smart visualization platform that brings insights from pest activity and weather data across **Cicalino** and **Imola** locations.
