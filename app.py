...
st.markdown("""
This Streamlit app showcases the Exploratory Data Analysis (EDA) and Preprocessing 
steps performed on an agricultural pest dataset.
""")

# Data Loading Section
st.header("1. Dataset Overview")
st.write("Loading the dataset and showing first few rows:")

# --- Original code starts here ---
#!/usr/bin/env python
# coding: utf-8

# <a href="https://colab.research.google.com/github/raz0208/Agritech-Pest-Prediction/blob/main/Agritech_Pest_EDA_and_Preprocessing.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
# ### 9. Line plot: Date vs Number of Insects
...
# ## Visuaization for Weather variables
